...
<head>
    ...
    <title>BukuKita | pinjam.in - Daftar Perpustakaan</title>
    ...
    <style>
        *{font-family:'Poppins',sans-serif;}
        ...
        /* Register Card */
        .register-card{background:rgba(1,60,88,0.85);backdrop-filter:blur(10px);border-radius:30px;box-shadow:0 25px 50px rgba(0,0,0,0.3);max-width:500px;width:100%;overflow:hidden;position:relative;z-index:10;border:1px solid rgba(255,255,255,0.2);}
        .register-header{background:rgba(0,83,122,0.5);padding:35px 30px 0 30px;text-align:center;}
        .register-header .logo i{font-size:50px;color:#FFD35B;}
        .register-header h2{font-weight:700;font-size:28px;color:#FFD35B;margin-bottom:8px;}
        .register-header .subtitle{color:#A8E8F9;font-size:13px;}
        .register-header .subtitle a{color:#F5A201;text-decoration:none;font-weight:600;}
        ...
        .login-link a{color:#F5A201;font-weight:600;text-decoration:none;font-size:13px;}
